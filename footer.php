...
<section class="info_section">
    <div class="container">
      <!-- Info Contact -->
      <div class="contact_nav text-center">
        ...
        <div class="row justify-content-center">
          ...
          <div class="row justify-content-center text-center mx-auto">
            <div class="info_links">
              <h4>Navigation</h4>
              <div class="info_links_menu text-left">
                <a href="index.php">Start</a>
                <a href="ueber-mich.php">Über mich</a>
                <a href="psychologische-beratung.php">Psychologische Beratung</a>
                <a href="beratung-zur-persoenlichkeitsentwicklung.php">Beratung zur Persönlichkeitsentwicklung</a>
          ...
          <!-- Info Instagram -->
          <div class="col-sm-6 col-md-4 col-lg-3 text-center my-2 m-auto">
            <div class="info_post">
              <h4>Instagram</h4>
